...
public class Dos extends javax.swing.JFrame {
    public static String message = "Hola PA!";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("YA LLEG0 EL DED YATTATATA");
        ...
        getAccessibleContext().setAccessibleDescription("Ta chido");

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        System.out.println("Hola uwu" + this.jTextField1.getText());
